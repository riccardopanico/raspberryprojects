...
def upgrade():
    ...
    op.bulk_insert(variables_table, [
        {"variable_code": "articolo", "variable_name": "Articolo", "string_value": "ZRACHELLE-0", "numeric_value": None, "boolean_value": None, "device_id": None, "created_at": created_at_value},
