...
<script>
    ...
    function openModal(setting) {
        ...
        const modalSettings = {
            ...
            'arresta': {
                title: '<div class="text-center" style="font-weight: bold; font-size: 18px;">Spegnimento</div>',
                dialogClass: 'modal-dialog modal-xl modal-dialog-centered',
                body: `<div class="text-center" style="font-size: 1.0rem;">Sicuro di voler arrestare il dispositivo?</div>`,
                footerClass: 'modal-footer justify-content-between',
                footer: `
