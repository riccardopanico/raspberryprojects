        ...
        <form action="{{ route('signin') }}" method="POST">
            ...
            <div class="row">
                <div class="col-12 btn-group-vertical" role="group">
                    <div class="btn-group">
                        <button type="button" class="font-lg btn btn-outline-secondary py-3" style="font-size: 23px"
                    ...
                    <div class="btn-group">
                        <button style="width: 33.333%; font-size: 23px" type="button"
                        ...
                        <button style="width: 33.333%; font-size: 23px" type="submit"
