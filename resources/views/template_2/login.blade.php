            ...
            <form action="{{ route('signin') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-12 btn-group-vertical" role="group">
                        <div class="btn-group">
                            <button type="button" class="font-lg btn btn-outline-secondary py-3" style="font-size: 20px"
                        ...
                        <div class="btn-group">
                            <button style="width: 33.333%; font-size: 20px" type="button" class="font-lg btn btn-outline-secondary py-3"
                                onclick="cancelNumpad()"><i class="fas fa-backspace"></i></button>
                            <button style="width: 33.333%; font-size: 20px" type="button"
                                class="font-lg btn btn-outline-secondary py-3" onclick="inputNumpad(0)">0</button>
                            <button style="width: 33.333%; font-size: 20px" type="submit" class="font-lg btn btn-primary py-3"><i
